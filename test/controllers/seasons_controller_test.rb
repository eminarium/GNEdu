...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { notes: @season.notes, seasonFromDate: @season.seasonFromDate, seasonTitle: @season.seasonTitle, seasonToDate: @season.seasonToDate }
    end
  ...
  test "should update season" do
    patch :update, id: @season, season: { notes: @season.notes, seasonFromDate: @season.seasonFromDate, seasonTitle: @season.seasonTitle, seasonToDate: @season.seasonToDate }
    assert_redirected_to season_path(assigns(:season))
  end
