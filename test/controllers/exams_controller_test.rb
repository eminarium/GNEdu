...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { examDate: @exam.examDate, examResult: @exam.examResult, examinee_id: @exam.examinee_id, notes: @exam.notes, subject_id: @exam.subject_id }
    end
  ...
  test "should update exam" do
    patch :update, id: @exam, exam: { examDate: @exam.examDate, examResult: @exam.examResult, examinee_id: @exam.examinee_id, notes: @exam.notes, subject_id: @exam.subject_id }
    assert_redirected_to exam_path(assigns(:exam))
  end
