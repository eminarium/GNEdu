...
class AnnouncementsControllerTest < ActionController::TestCase
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post :create, announcement: { announcementBody: @announcement.announcementBody, announcementSubject: @announcement.announcementSubject }
    end
  ...
  test "should update announcement" do
    patch :update, id: @announcement, announcement: { announcementBody: @announcement.announcementBody, announcementSubject: @announcement.announcementSubject }
    assert_redirected_to announcement_path(assigns(:announcement))
  end
