...
class EventTypesControllerTest < ActionController::TestCase
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post :create, event_type: { event_type_color_code: @event_type.event_type_color_code, event_type_title: @event_type.event_type_title, notes: @event_type.notes }
    end
  ...
  test "should update event_type" do
    patch :update, id: @event_type, event_type: { event_type_color_code: @event_type.event_type_color_code, event_type_title: @event_type.event_type_title, notes: @event_type.notes }
    assert_redirected_to event_type_path(assigns(:event_type))
  end
